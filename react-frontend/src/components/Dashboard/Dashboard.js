            ...
            <div className="flex w-10">
                <div className=" w-8">
                    ...
                    <div className="w-full flex justify-content-center flex-wrap ">
                        <></>
                <div className='col-12 lg:col-6 xl:col-4'><Link to='/intents'><div className='card mb-0 flex flex-column align-items-center justify-content-center hover zoom' style={{ height: '10rem' }}><div className='text-900 font-medium text-lg'>Intents</div></div></Link></div>
